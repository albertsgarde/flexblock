...
fn voxel_entry_exit(origin: Vec3, direction: Vec3, voxel_corner: Vec3, voxel_size: f32) -> (Vec3, Vec3) {
...
/// 
/// Panics if `direction` is the zero vector.
pub fn voxel_exit_voxel(origin: Vec3, direction: Vec3, voxel_corner: Vec3, voxel_size: f32) -> Option<Vec3> {
    let (t_min, t_max): (Vec3, Vec3) = voxel_entry_exit(origin, direction, voxel_corner, voxel_size);
...
pub fn voxel_exit(origin: Vec3, direction: Vec3, voxel_corner: Vec3, voxel_size: f32) -> Option<(f32, Vec3)> {
    let (t_min, t_max): (Vec3, Vec3) = voxel_entry_exit(origin, direction, voxel_corner, voxel_size);
