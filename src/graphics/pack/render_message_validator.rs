...
use crate::graphics::{RenderMessages, RenderMessage, wrapper::ShaderMetadata, UniformData, GraphicsCapabilities};
...
mod tests {
    ...
    fn basic_validation() { // Does extremely basic validation
        ...
        render_messages.add_message(RenderMessage::ChooseShader { shader : ShaderIdentifier::DefaultShader } );
