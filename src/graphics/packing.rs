...
use super::{RenderPack,RenderMessage, VertexPack, UniformData};
...
pub fn start_packing_thread(rx: LogicToPackingReceiver, tx: PackingToWindowSender) -> JoinHandle<()> {
    thread::spawn(move || {
        ...
        for _ in rx.channel_receiver.iter() {
            ...
            &glm::vec3(center[0], center[1], center[2]), &glm::vec3(0., 1., 0.));
            ...
            let vertex_pack = VertexPack::new(
                vec![
                    Vertex3D {x : -0.5, y : -0.5, z : -40., r : 0., g : 0., b : 0.5},
                    Vertex3D {x : 0.5, y : -0.5, z : -40., r : 0., g : 0., b : 0.5},
                    Vertex3D {x : 0.5, y : 0.5, z : -40., r : 0., g : 0., b : 0.5},

                    Vertex3D {x : 1., y : -0.5, z : -0.5, r : 0., g : 0.5, b : 0.},
                    Vertex3D {x : 1., y : 0.5, z : -0.5, r : 0., g : 0.6, b : 0.},
                    Vertex3D {x : 1., y : 0.5, z : 0.5, r : 0., g : 0.7, b : 0.},

                    Vertex3D {x : 0.5, y : -0.5, z : -1., r : 0., g : 0.3, b : 0.},
                    Vertex3D {x : 0.5, y : 0.5, z : -1., r : 0., g : 0.3, b : 0.},
                    Vertex3D {x : -0.5, y : 0.5, z : -1., r : 0., g : 0.3, b : 0.},
                    
                    Vertex3D {x : 5.5, y : -0.5, z : -1., r : 0., g : 0.3, b : 0.},
                    Vertex3D {x : 5.5, y : 0.5, z : -1., r : 0., g : 0.3, b : 0.},
                    Vertex3D {x : -0.5, y : 0.5, z : -1., r : 0., g : 0.3, b : 0.},

                    Vertex3D {x : 5.5, y : -0.5, z : -6., r : 0., g : 0.3, b : 0.},
                    Vertex3D {x : 5.5, y : 5.5, z : -6., r : 0., g : 0.3, b : 0.},
                    Vertex3D {x : -0.5, y : 0.5, z : -6., r : 0., g : 0.3, b : 0.},

                    Vertex3D {x : 50., y : -50., z : 0.0, r : 0., g : 0., b : 1.},
                    Vertex3D {x : 50., y : 50., z : 0.0, r : 0., g : 0., b : 1.},
                    Vertex3D {x : -50., y : 50., z : 0.0, r : 0., g : 0., b : 1.},
                    

                    Vertex3D {x : -50.0, y : -1., z : -50.0, r : 0.5, g : 0.5, b : 0.2},
                    Vertex3D {x : 0., y : -1., z : -50.0, r : 0.5, g : 0.5, b : 0.2},
                    Vertex3D {x : -50., y : -1., z : 0.0, r : 0.5, g : 0.5, b : 0.2},

                    Vertex3D {x : -50., y : -1., z : 0.0, r : 0.5, g : 0.5, b : 0.2},
                    Vertex3D {x : 0., y : -1., z : -50.0, r : 0.5, g : 0.5, b : 0.2},
                    Vertex3D {x : 0., y : -1., z : 0.0, r : 0.5, g : 0.5, b : 0.2},


                    Vertex3D {x : -0.0, y : -1., z : -50.0, r : 0.5, g : 0.5, b : 0.2},
                    Vertex3D {x : 50., y : -1., z : -50.0, r : 0.5, g : 0.5, b : 0.2},
                    Vertex3D {x : -0., y : -1., z : 0.0, r : 0.5, g : 0.5, b : 0.2},

                    Vertex3D {x : -0., y : -1., z : 0.0, r : 0.5, g : 0.5, b : 0.2},
                    Vertex3D {x : 50., y : -1., z : -50.0, r : 0.5, g : 0.5, b : 0.2},
                    Vertex3D {x : 50., y : -1., z : 00.0, r : 0.5, g : 0.5, b : 0.2},
                    

                    Vertex3D {x : -0.0, y : -1., z : -0.0, r : 0.5, g : 0.5, b : 0.2},
                    Vertex3D {x : 50., y : -1., z : -0.0, r : 0.5, g : 0.5, b : 0.2},
                    Vertex3D {x : -0., y : -1., z : 50.0, r : 0.5, g : 0.5, b : 0.2},
                    ...
                    Vertex3D {x : -50.0, y : -1., z : -0.0, r : 0.5, g : 0.5, b : 0.2},
                    Vertex3D {x : 0., y : -1., z : -0.0, r : 0.5, g : 0.5, b : 0.2},
                    Vertex3D {x : -50., y : -1., z : 50.0, r : 0.5, g : 0.5, b : 0.2},
